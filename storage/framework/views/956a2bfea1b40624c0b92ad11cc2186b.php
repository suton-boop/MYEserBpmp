...
<?php $__env->startSection('title', 'Beranda - E-Sertifikat BPMP Kaltim'); ?>
...
<div class="row align-items-center g-5 py-5">
    <div class="col-lg-6">
        ...
        <div class="d-flex flex-wrap gap-3">
            <a href="<?php echo e(route('public.search')); ?>" class="btn btn-primary btn-lg px-4 fw-bold shadow-sm d-flex align-items-center gap-2 rounded-3" style="background: var(--nav-blue); border-color: var(--nav-blue);">
                <i class="fa-solid fa-magnifying-glass"></i> Cari Sertifikat
            </a>
            <a href="<?php echo e(route('public.verify.form')); ?>" class="btn btn-outline-dark btn-lg px-4 fw-bold d-flex align-items-center gap-2 rounded-3">
...
<div class="row g-4 mb-5 pb-5 mt-2">
    <div class="col-md-6">
        <div class="card border border-light shadow-sm rounded-4 p-4 text-center overflow-hidden position-relative stat-card bg-white">
            <div class="position-relative z-1">
                <div class="display-4 mb-1 fw-bold" style="color: var(--nav-blue);"><?php echo e(number_format($stats['total_certificates'], 0, ',', '.')); ?></div>
    ...
    <div class="col-md-6">
        <div class="card border border-light shadow-sm rounded-4 p-4 text-center overflow-hidden position-relative stat-card bg-white">
            <div class="position-relative z-1">
                <div class="display-4 mb-1 fw-bold" style="color: var(--nav-blue-2);"><?php echo e(number_format($stats['total_participants'], 0, ',', '.')); ?></div>
...
<?php echo $__env->make('public.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\esertifikatv1\resources\views/public/home.blade.php ENDPATH**/ ?>