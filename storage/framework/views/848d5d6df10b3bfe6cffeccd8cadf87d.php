...
<?php $__env->startSection('title','Monitoring Sistem'); ?>
...
<div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
  ...
  <div class="d-flex gap-2">
      <form action="<?php echo e(route('admin.monitoring.retryFailed')); ?>" method="POST" onsubmit="return confirm('Mencoba ulang semua proses yang gagal?')">
          <?php echo csrf_field(); ?>
      ...
      <form action="<?php echo e(route('admin.monitoring.clearFailed')); ?>" method="POST" onsubmit="return confirm('Menghapus semua daftar tugas yang gagal (failed jobs) secara permanen?')">
          <?php echo csrf_field(); ?>
      ...
      <div class="card-body px-2">
        <div class="d-flex align-items-center justify-content-between">
          <div>
            ...
            <h3 class="mb-0 fw-bold <?php echo e($pendingJobs > 0 ? 'text-warning' : 'text-dark'); ?>"><?php echo e(number_format($pendingJobs)); ?></h3>
          </div>
      ...
      <div class="card-body px-2">
        <div class="d-flex align-items-center justify-content-between">
          <div>
            ...
            <h3 class="mb-0 fw-bold <?php echo e($failedJobs > 0 ? 'text-danger' : 'text-dark'); ?>"><?php echo e(number_format($failedJobs)); ?></h3>
          </div>
      ...
      <div class="card-body px-2">
        <div class="d-flex align-items-center justify-content-between">
          <div>
            ...
            <h3 class="mb-0 fw-bold text-success"><?php echo e(number_format($totalCertificatesGenerations)); ?></h3>
          </div>
      ...
      <div class="card-body px-2">
        <div class="d-flex align-items-center justify-content-between">
          <div>
            ...
            <h3 class="mb-0 fw-bold text-warning"><?php echo e(number_format($pendingTte)); ?></h3>
          </div>
          <div class="rounded-circle bg-warning bg-opacity-10 text-warning d-flex align-items-center justify-content-center" style="width: 40px; height: 40px; font-size: 18px;">
      ...
      <div class="card-body px-2">
        <div class="d-flex align-items-center justify-content-between">
          <div>
            ...
            <h3 class="mb-0 fw-bold text-primary"><?php echo e(number_format($totalTteSigned)); ?></h3>
          </div>
      ...
      <div class="card-body px-2">
        <div class="d-flex align-items-center justify-content-between">
          <div>
            ...
            <div class="fw-bold text-info text-truncate small" style="max-width: 130px;" title="<?php echo e($lastNumber); ?>"><?php echo e($lastNumber); ?></div>
          </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0 font-monospace" style="font-size: 13px;">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td class="text-muted">#<?php echo e($job->id); ?></td>
                            <td><span class="badge bg-light text-dark border"><?php echo e($className); ?></span></td>
                            <td><?php echo e(\Carbon\Carbon::parse($job->created_at)->diffForHumans()); ?></td>
                            <td class="text-center"><?php echo e($job->attempts); ?></td>
                        </tr>
        ...
        <div class="card border-0 shadow-sm rounded-4 h-100">
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0 font-monospace" style="font-size: 13px;">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $recentFailedJobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                        ...
                        ?>
                        <tr>
                            <td class="text-muted">#<?php echo e($fail->id); ?></td>
                            <td><span class="badge bg-danger bg-opacity-10 text-danger border border-danger"><?php echo e($className); ?></span></td>
                            <td><?php echo e(\Carbon\Carbon::parse($fail->failed_at)->diffForHumans()); ?></td>
                            <td>
                                <div class="text-truncate text-danger" style="max-width: 200px;" title="<?php echo e($errorHint); ?>">
                                    <?php echo e($errorHint); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\esertifikatv1\resources\views/admin/monitoring/index.blade.php ENDPATH**/ ?>