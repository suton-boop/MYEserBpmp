  ...
  <div class="card-body">
    <div class="row g-3">
      ...
      <div class="col-md-6">
        ...
        <input name="email" type="email" class="form-control" value="<?php echo e(old('email', $participant->email)); ?>" required>
      </div>
      ...
      <div class="col-md-6">
        ...
        <input name="institution" class="form-control" value="<?php echo e(old('institution', $participant->institution)); ?>" required>
      </div>
      ...
      <div class="col-md-6">
        ...
        <input name="custom_date" type="date" class="form-control" value="<?php echo e(old('custom_date', $participant->custom_date ? $participant->custom_date->format('Y-m-d') : '')); ?>">
      ...
      <div class="col-md-12">
        ...
        <textarea name="metadata" class="form-control font-monospace" rows="3" placeholder='Contoh: {"nilai_praktek": 95, "jam_pelajaran": 40}'><?php echo e(old('metadata', $participant->metadata ? json_encode($participant->metadata, JSON_PRETTY_PRINT) : '')); ?></textarea>
