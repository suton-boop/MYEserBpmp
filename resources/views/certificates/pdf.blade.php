...
@php
  ...
  $fontNameParticipant = \App\Models\Setting::getValue('font_name_participant', "'Great Vibes', cursive");
  $fontRoleParticipant = \App\Models\Setting::getValue('font_role_participant', "'Alex Brush', cursive");
  ...
  $defaults = [
    ...
    'name'        => ['x'=>0, 'y'=>315, 'w'=>1123, 'font'=>48, 'color'=>'#0b5fa8', 'align'=>'center', 'weight'=>'700', 'fontFamily'=>$fontNameParticipant],
    ...
    'peran'       => ['x'=>0, 'y'=>425, 'w'=>1123, 'font'=>20, 'color'=>'#0b5fa8', 'align'=>'center', 'weight'=>'400', 'fontFamily'=>$fontRoleParticipant],
  ...
  @if(isset($fields['desc']) && $descText !== '')
    <div class="field"
         style="
           ...
           font-size: {{ $get($fDesc,'font', 15) }}px;
