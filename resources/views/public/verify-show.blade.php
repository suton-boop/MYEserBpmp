...
@section('title', 'Hasil Verifikasi - BPMP Kaltim')
@section('breadcrumb', 'Hasil Verifikasi')
                ...
                <div class="row g-5">
                    <div class="col-md-7">
                        <div class="mb-5">
                            ...
                            <h4 class="fw-bold text-dark font-monospace">{{ $cert->certificate_number }}</h4>
                        </div>
                        
                        <div class="row g-4 mb-5">
                            <div class="col-12">
                                <label class="text-uppercase text-muted fw-bold small mb-2 tracking-wider" style="letter-spacing: 1px;">Nama Peserta</label>
                                <h3 class="fw-800 text-dark mb-1" style="font-weight: 800;">{{ $cert->participant->name }}</h3>
                                <div class="text-primary fw-semibold">{{ $cert->participant->institution ?? '-' }}</div>
                            </div>
                        </div>
                        ...
                        <div class="mb-0">
                            ...
                            <h5 class="fw-bold text-dark mb-3 lh-base">{{ $cert->event->name }}</h5>
                    ...
                    <div class="col-md-5">
                        <div class="h-100 bg-light rounded-4 p-4 d-flex flex-column justify-content-between border border-light shadow-sm">
                            ...
                            <div class="mt-auto">
                                <a href="{{ route('public.download', $cert->verify_token) }}" target="_blank" class="btn btn-primary btn-lg w-100 rounded-3 fw-bold d-flex align-items-center justify-content-center gap-2 py-3 shadow-sm ripple">
                                    <i class="fa-solid fa-cloud-arrow-down"></i> UNDUH SERTIFIKAT
                                </a>
                                <p class="text-center mt-3 mb-0">
                                    <a href="{{ route('public.verify.form') }}" class="text-decoration-none small text-muted hover-primary">
        ...
        <div class="card border-0 shadow-sm rounded-4 bg-white overflow-hidden mb-4" data-aos="zoom-in">
            <div class="card-body p-5 text-center">
                ...
                <div class="d-flex flex-wrap justify-content-center gap-3">
                    <a href="{{ route('public.verify.form') }}" class="btn btn-primary btn-lg px-5 fw-bold rounded-3 shadow-sm">
                        <i class="fa-solid fa-rotate-left me-2"></i> Coba Lagi
                    </a>
                    <a href="{{ route('public.home') }}" class="btn btn-outline-dark btn-lg px-5 fw-bold rounded-3">
                        Halaman Utama
                    </a>
                </div>
            </div>
